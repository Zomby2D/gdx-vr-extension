...
public class GvrAndroidApplication extends GvrActivity implements AndroidApplicationBase {

    static {
        GdxNativesLoader.load();
    }

    protected GvrAndroidGraphics graphics;
    ...
    private void init (ApplicationListener listener, AndroidApplicationConfiguration config, boolean isForView) {
        ...
        graphics = new GvrAndroidGraphics(this, config, config.resolutionStrategy == null ? new FillResolutionStrategy()
    ...
    public void onCardboardTrigger() {
        if (!(listener instanceof GvrApplicationListener)) {
            throw new RuntimeException("should implement CardBoardApplicationListener");
        }
        ((GvrApplicationListener)listener).onCardboardTrigger();
    }
    ...
    public void exit () {
        handler.post(new Runnable() {
            @Override
            public void run () {
                GvrAndroidApplication.this.finish();
            }
        });
    }
