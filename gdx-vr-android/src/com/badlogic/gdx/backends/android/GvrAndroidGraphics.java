...
public class GvrAndroidGraphics implements Graphics, GvrView.StereoRenderer{

    private static final String LOG_TAG = "GvrAndroidGraphics";
    ...
    public GvrAndroidGraphics (AndroidApplicationBase application, AndroidApplicationConfiguration config,
    ...
    public void onNewFrame (HeadTransform headTransform) {
        ...
        frames++;
        if (!(app.getApplicationListener() instanceof GvrApplicationListener)) {
            throw new RuntimeException("should implement GvrApplicationListener");
        }
        if (!disposed) {
            ((GvrApplicationListener) app.getApplicationListener())
    ...
    public void onRendererShutdown () {
        ...
        ((GvrApplicationListener)app.getApplicationListener()).onRendererShutdown();
    }
