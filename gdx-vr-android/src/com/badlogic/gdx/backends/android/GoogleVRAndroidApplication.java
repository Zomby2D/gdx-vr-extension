...
public class GoogleVRAndroidApplication extends GvrActivity implements AndroidApplicationBase {

	static {
		GdxNativesLoader.load();
	}

	protected GoogleVRAndroidGraphics graphics;
	...
	public void exit () {
		handler.post(new Runnable() {
			@Override
			public void run () {
				GoogleVRAndroidApplication.this.finish();
			}
		});
	}
