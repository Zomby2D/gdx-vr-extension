 ...
 * {@link Camera#far} and {@link #offset} will be overwritten on every call to {@link #update()} based on the tracked values from
 * the head mounted display. The {@link #offset} vector allows you to position the camera in world space.
 * @author badlogic */
